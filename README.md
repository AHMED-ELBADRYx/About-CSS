  ...
  - `minmax()`: أدنى وأقصى بعد للعنصر الواحد (على حسب خاصية `grid-template-columns` أو `grid-template-rows`)
    ...
    - مثلا:
      ...
      - ```css
        width: 500px;
        display: grid;
        grid-template-columns: minmax(100px, 200px) 250px; /* item1 = 200px, item2 = 250px */
        grid-template-columns: minmax(100px, 200px) 350px; /* item1 = 150px, item2 = 350px */
        grid-template-columns: minmax(100px, 200px) 400px; /* item1 = 100px, item2 = 400px */
        grid-template-columns: minmax(100px, 200px) 450px; /* item1 = 100px, item2 = 450px */
        ```

    - `grid-template-columns` الأولى: القيمة المتبقية للعنصر الأول هي `250` فأخذ `200` فقط لأنها أقصى قيمة
    - `grid-template-columns` الثانية: القيمة المتبقية للعنصر الأول هي `150` فأخذها
